...
async function constructNewGame(
    ...
    const territoryBridges: TerritoryBridge[] = await api.get<TerritoryBridge[]>('/game-data/standard/territory-bridges.json');
    const territoryPathDefinitions: TerritoryPathDefinition[] = await api.get<TerritoryPathDefinition[]>('/game-data/standard/territory-path-definitions.json');
